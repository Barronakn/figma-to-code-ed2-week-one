    ...
    <section className="flex flex-col gap-9 pb-24">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-stretch  sm:items-center text-sm font-semibold gap-2">
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-2 ">
          <button className="bg-neutral-800 text-sm font-semibold py-2 px-6 text-white rounded-xl">
            All categories
          </button>
        ...
        <div>
          <a className="text-sm font-semibold underline hover:bg-black hover:bg-opacity-20" href="#">
            View more
          </a>
        </div>
      </div>
