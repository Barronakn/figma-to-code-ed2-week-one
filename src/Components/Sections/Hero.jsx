...
const Hero = () => {
  return (
      <section className="hero flex xl:flex-row flex-col py-24 2xl:justify-between gap-10 sm:gap-2 mx-0">
        ...
        <div className="right w-full xl:w-1/2 flex flex-row px-0 sm:px-6 xl:px-0 justify-center gap-3">
          <div className="flex flex-col">
            ...
            <div className="w-60 sm:w-72 h-[442px]">
              <img
                className="pointer-events-none object-cover rounded-full w-72 h-[442px]"
                src={hero1}
                alt="hero1-img"
              />
            </div>
          </div>
          <div className="transform sm:translate-x-0 translate-x-1/2">
            <img
              className="pointer-events-none object-cover rounded-full w-72 h-[442px]"
              src={hero2}
              alt="hero2-img"
